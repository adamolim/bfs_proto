...
\hypersetup{
  pdftitle={Dépenses pour les prestations sociales},
  pdfauthor={Office fédéral de la statistique - Section bla bla bla},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Dépenses pour les prestations sociales}
\usepackage{etoolbox}
\makeatletter
...
\makeatother
\subtitle{Résultats pour le canton de XY}
\author{Office fédéral de la statistique - Section bla bla bla}
\date{2023-09-23}
...
{\bfseries{\nohyphens{Dépenses pour les prestations sociales}}}\par
}%

\vspace{\betweentitlesubtitle}
{
\fontsize{18}{21.599999999999998}\selectfont
{\textit{\nohyphens{Résultats pour le canton de XY}}}\par
}}
\newcommand{\titlepagetitleblock}{
\titleandsubtitle
}

\newcommand{\authorstyle}[1]{{\fontsize{14}{16.8}\selectfont
\textit{#1}}}

\newcommand{\affiliationstyle}[1]{{\large{#1}}}

\newcommand{\titlepageauthorblock}{
{\authorstyle{\nohyphens{Office fédéral de la statistique - Section bla
bla bla}}}}
...
\setlength{\bgimagesize}{25cm}
\LENGTHDIVIDE{\bgimagesize}{\paperwidth}{\theRatio} % from calculator pkg
\ThisULCornerWallPaper{\theRatio}{img/logo.png}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, boxrule=0pt, enhanced, frame hidden, breakable, interior hidden]}{\end{tcolorbox}}\fi
...
Look at this https://nmfs-opensci.github.io/quarto\_titlepages/
...
\begin{tcolorbox}[colback=black!10!white,
colframe=black!10!white,
title = Remarque, toptitle=3mm,
coltitle = black!90!white,
coltext = black!90!white, sharp corners, 
fonttitle=\small\bfseries, fontupper=\small]
This is a colored text box. ttis diam vitae bibendum consequat. Etiam vitae eros tristique, porta sapien a,aliquet mauris. Praesent ultricies mi nulla, et dignissim nulla mattis at. Fusce rhoncusleo quis od https://texdoc.org/serve/tcolorbox.pdf/0
\end{tcolorbox}
...
Ici d'autres analyses\ldots{}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(iris}\SpecialCharTok{$}\NormalTok{Sepal.Width }\SpecialCharTok{\textasciitilde{}}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Sepal.Length, }\AttributeTok{col =}\NormalTok{ iris}\SpecialCharTok{$}\NormalTok{Species)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{bfs_proto_files/figure-pdf/unnamed-chunk-1-1.pdf}
...
{\centering \includegraphics{img/ringed-seal.png}
